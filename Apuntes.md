...
* Dinamica por MAC: El servidor sigue usando DHCP, pero identifica al cliente por su MAC. Si la máquina se conecta dentro de la misma red recibe una IP dinamicamente (se le pueden dar diferentes IPS).
